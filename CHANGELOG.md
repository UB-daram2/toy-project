...
- **홈 히어로 재설계**: 장식용 그라데이션 "홈" 대형 텍스트 제거, 오늘 날짜·인사말·포털 타이틀("유팜 기술지원 포털")·태그라인으로 교체. 검색 중에는 타이틀·섹션 버튼이 숨겨지는 컴팩트 모드 전환.
...
- 커버리지: 구문 97.3% / 브랜치 91.4% / 함수 97.6% / 라인 98.4%
- E2E: smoke(3) + widgets(14) + section(4) + viewport(9) = 총 30건 (4종 스펙)
